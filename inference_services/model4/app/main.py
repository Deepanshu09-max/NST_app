...
def resolve_model_path(model_path: str):
    base_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../persistent_storage/models/model4"))
